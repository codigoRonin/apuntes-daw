...
| [UD3. Aprendizaje automático: enfoques, modelos, ajuste y validación](ud3-aprendizaje-automatico.md) | Qué es aprender de los datos y los cuatro enfoques, la gramática de scikit-learn (estimador, división, pipeline), regresión lineal y su coeficiente de determinación, árboles de decisión y matriz de confusión, ajuste de hiperparámetros con validación cruzada, agrupamiento con k-medias, verificación más allá de la métrica (línea base, fuga de datos, sesgo) y la ficha del modelo — sobre datos ficticios de un portal comarcal de vivienda |

Las unidades restantes (de la UD4 a la UD6) **se publicarán progresivamente** a lo largo del curso, siempre antes de comenzar a impartirlas. Si una unidad no aparece aquí, aún no está publicada — no la busques en otros canales.
